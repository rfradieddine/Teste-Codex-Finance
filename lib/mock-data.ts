  ...
  cardInvoices: [
    {
      ...
      amount: "R$ 3.090,00",
      amountInput: "3090",
      dueLabel: "Vence dia 12",
      closingLabel: "Fecha dia 05",
      status: "Fatura atual",
      utilization: "12% do limite",
    },
    {
      id: "invoice-2",
      cardId: "card-1",
      ...
      dueLabel: "Vence dia 12",
      closingLabel: "Fecha dia 05",
      status: "Proxima fatura",
      utilization: "0% do limite",
      isProjected: true,
    },
    {
      id: "invoice-3",
      cardId: "card-2",
      cardName: "Visa viagens",
      monthKey: "2026-04",
      monthLabel: "Abr/2026",
      amount: "R$ 1.420,00",
      amountInput: "1420",
      dueLabel: "Vence dia 20",
      closingLabel: "Fecha dia 10",
      status: "Fatura atual",
